<%-- 
    ...
    Created on : Nov 27, 2021, 3:57:52 PM
    Author     : wfran
--%>
            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <a class="btn btn-primary" href="crearcita.jsp">Crear Cita</a><br><br>
                        <a class="btn btn-primary" href="registrarmedico.jsp">Crear Medico</a><br><br>
                        <a class="btn btn-primary" href="eliminarmedico.jsp">Eliminar Medico</a><br><br>
                        <a class="btn btn-primary" href="consultarcitas.jsp">Consultar Citas</a>
                    </div>
                </div>
            </div>
        </header>
